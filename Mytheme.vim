...
let g:airline#themes#Mytheme#palette.insert = airline#themes#generate_color_map(s:I1, s:N2, s:I3)
...
let g:airline#themes#Mytheme#palette.replace = {
      ...
      \ }
let g:airline#themes#Mytheme#palette.replace_modified = copy(g:airline#themes#Mytheme#palette.insert_modified)
...
let g:airline#themes#Mytheme#palette.visual = airline#themes#generate_color_map(s:V1, s:N2, s:V3)
let g:airline#themes#Mytheme#palette.visual_modified = copy(g:airline#themes#Mytheme#palette.insert_modified)
